...
from studinfosys.models.student import Student
from studinfosys.models.course import Course
from studinfosys.models.college import College
...
def colleges() -> str:
    ...
    colleges = College().get_all(current_page, 7)
...
def next() -> str:
    ...
    current_page += 1
    limit_page = ceil(college_count/7)
